        ...
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 24 }}>
              <a href="/privacy" style={{ fontSize: 13, color: TEAL, textDecoration: 'none', fontWeight: 500 }}>Privacy Policy</a>
              <a href="/terms" style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', textDecoration: 'none', fontWeight: 500 }}>Terms of Service</a>
